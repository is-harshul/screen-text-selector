...
Latest installers: [**Releases page**](https://github.com/is-harshul/text-extractor/releases/latest) · current **v0.2.2**.

| OS | Installer | Direct download |
| --- | --- | --- |
| macOS (Apple silicon — M1/M2/M3) | `Text Extractor_0.2.2_aarch64.dmg` | [⬇ download](https://github.com/is-harshul/text-extractor/releases/latest/download/Text.Extractor_0.2.2_aarch64.dmg) |
| macOS (Intel) | `Text Extractor_0.2.2_x64.dmg` | [⬇ download](https://github.com/is-harshul/text-extractor/releases/latest/download/Text.Extractor_0.2.2_x64.dmg) |
| Windows (installer) | `Text Extractor_0.2.2_x64-setup.exe` | [⬇ download](https://github.com/is-harshul/text-extractor/releases/latest/download/Text.Extractor_0.2.2_x64-setup.exe) |
| Windows (MSI) | `Text Extractor_0.2.2_x64_en-US.msi` | [⬇ download](https://github.com/is-harshul/text-extractor/releases/latest/download/Text.Extractor_0.2.2_x64_en-US.msi) |
| Linux (.deb) | `Text Extractor_0.2.2_amd64.deb` | [⬇ download](https://github.com/is-harshul/text-extractor/releases/latest/download/Text.Extractor_0.2.2_amd64.deb) |
| Linux (.AppImage) | `Text Extractor_0.2.2_amd64.AppImage` | [⬇ download](https://github.com/is-harshul/text-extractor/releases/latest/download/Text.Extractor_0.2.2_amd64.AppImage) |
...
>
> If a link 404s after a version bump, the version segment in the filename changed (e.g. `0.1.0` → `0.2.2`). Open the [Releases page](https://github.com/is-harshul/text-extractor/releases/latest) and grab the file by hand.
...
```
release/
└── Text Extractor_0.2.2_universal.dmg     # macOS
    Text Extractor_0.2.2_amd64.deb         # Linux
    text-extractor_0.2.2_amd64.AppImage    # Linux
    Text Extractor_0.2.2_x64_en-US.msi     # Windows
    Text Extractor_0.2.2_x64-setup.exe     # Windows
```
